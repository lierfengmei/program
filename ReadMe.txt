================================================================================
    MICROSOFT 基础类库： program_balise 项目概述
===============================================================================

应用程序向导已为您创建了此 program_balise 应用程序。此应用程序
不仅介绍了使用 Microsoft 基础类的基本知识，
而且是编写应用程序的起点。

此文件包含组成 program_balise 应用程序的每个文件的内容摘要。

program_balise.vcproj
...
program_balise.h
    ...
    Cprogram_baliseApp 应用程序类。

program_balise.cpp
    这是包含应用程序
    类 Cprogram_baliseApp 的主应用程序源文件。
...
res\program_balise.ico
    这是一个图标文件，用作应用程序的图标。  此
    图标包含在主资源文件 program_balise.rc 中。

res\program_balise.rc2
    此文件包含不由 Microsoft 
...
res\Toolbar.bmp
    ...
    更新 program_balise.rc 中的 IDR_MAINFRAME TOOLBAR 数组以添加
    工具栏按钮。
/////////////////////////////////////////////////////////////////////////////

应用程序向导将创建一种文档类型和一个视图：

program_baliseDoc.h、program_baliseDoc.cpp - 文档
    这些文件包含 Cprogram_baliseDoc 类。  编辑这些文件
    以添加特殊的文档数据并实现文件的保存和加载
    （通过 Cprogram_baliseDoc::Serialize）。
program_baliseView.h、program_baliseView.cpp - 文档视图
    这些文件包含 Cprogram_baliseView 类。
    Cprogram_baliseView 对象用于查看 Cprogram_baliseDoc 对象。
/////////////////////////////////////////////////////////////////////////////
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 program_balise.pch 的预编译头文件 (PCH)
